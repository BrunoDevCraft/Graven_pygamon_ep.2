...
class MapManager:
    ...
    def __init__(self, screen, player):
        ...
        self.register_map("world", portals=[
            ...
            NPC("paul", nb_points=4, dialog=["Hello, je m'appel Paul", "@+"]), 
        ...
        self.teleport_npcs()  # Teleport NPCs before teleporting the player
        self.teleport_player("player")  # Teleport player to the dungeon spawn point
    ...
    def register_map(self, name, portals=[], npcs=[]):
        ...
        #definir une liste qui va stocker les murs
        walls = []
